        ...
        <View style={styles.wrapper}>
          <ImageBackground
            ...
            <LinearGradient
              ...
              <View style={[styles.flexCenter, styles.flexColumnCenter, {width: '100%'}]}>
                <Image
                  source={{
                ...
                <Text
                  style={{color: COLORS.TEXT_PRIMARY, fontSize: 13, paddingBottom: 20, paddingTop: 10}}>
                  {playlist?.sortDescription}
                </Text>
              </View>
            </LinearGradient>
          </ImageBackground>
          {playlist?.song?.items.length > 0 && (
            <ListSong songs={playlist.song.items} paddingVertical={7} />
          )}
          {playlist && (
            <View
              style={{
