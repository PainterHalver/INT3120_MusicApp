    ...
    Animated.timing(widthAnimation, {
        ...
        duration:
            lyrics && lyrics.length > 0
                ? lyrics[currentWord.line].words[currentWord.index].endTime -
                lyrics[currentWord.line].words[currentWord.index].startTime
                : 0,
                                        ...
                                        <View style={{ overflow: 'hidden', position: 'relative' }}>
                                            <Text
                                                style={[
                                                    ...
                                                    {
                                                        color:
                                                            i < currentWord.line || (i === currentWord.line && j < currentWord.index)
                                                                ? COLORS.TEXT_YELLOW
                                                                : COLORS.TEXT_WHITE_SECONDARY,
                                                    },
                                                ]}>
                                                {word.data}
                                            </Text>
                                            {j === currentWord.index && i === currentWord.line && (
                                                <Animated.View
                                                    style={[
                                                        animatedStyle,
                                                        { height: HEIGHTLINE, overflow: 'hidden', position: 'absolute' },
                                                    ]}>
